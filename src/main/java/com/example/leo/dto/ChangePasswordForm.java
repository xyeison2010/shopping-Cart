...
@NotNull private Long id; //tenemos el id para saber a k usuario le cambiamos el password
	
	@NotBlank(message="Current Password must not be blank")
	private String currentPassword; //el password actual k esta en la bd 

	@NotBlank(message="New Password must not be blank")
	private String newPassword; //el nuevo password

	@NotBlank(message="Confirm Password must not be blank")
	private String confirmPassword; //y la confirmacion
